...
def convert_cpp_to_java(cpp_code):
    ...
    # Enhanced prompt with specific library handling instructions
    prompt = (
        "You are a programming assistant. "
        "Convert the following C++ code to Java code completely, paying attention to:\n"
        "- Replace 'curl' with Java HTTP client methods.\n"
        "- Use 'ArrayList' for C++ 'vector'.\n"
        "- Handle JSON with 'Gson' or 'Jackson'.\n"
        f"{cpp_code}\n"
        "Java code:"
    )
